    ...
    public partial class UserList : Form
    {
        ...
        private void ApplyChanges_Click(object sender, EventArgs e)
        {
            if (NameBox.Text != "" && Surname.Text != "")
            {
                ...
                MessageBox.Show("Account : " + NameBox.Text + " " + Surname.Text + " Modified Succefully !");
